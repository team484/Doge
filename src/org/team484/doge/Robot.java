...
public class Robot extends IterativeRobot {
	...
	// CODE----------
	// ----------Joysticks----------
	public static final Joystick driveStickLeft = new Joystick(
			RobotMap.driveStickLeft);
	public static final Joystick operatorStick = new Joystick(
	...
	// ------Speed Controllers------
	public static final Talon frontLeftMotor = new Talon(
			RobotMap.frontLeftMotor);
	public static final Talon rearLeftMotor = new Talon(RobotMap.rearLeftMotor);
	public static final Talon frontRightMotor = new Talon(
			RobotMap.frontRightMotor);
	public static final Talon rearRightMotor = new Talon(
	...
	public static final Encoder leftEncoder = new Encoder(
			RobotMap.leftEncoderA, RobotMap.leftEncoderB,
			RobotMap.leftEncoderReverse);
	public static final Encoder rightEncoder = new Encoder(
			RobotMap.rightEncoderA, RobotMap.rightEncoderB,
			RobotMap.rightEncoderReverse);

	// ---Tote Pickup Hall Effect---
	public static final DigitalInput totePickupBottom = new DigitalInput(
			RobotMap.totePickupBottom);
	public static final DigitalInput totePickup1High = new DigitalInput(
	...
	public static final AnalogInput toteLeftIR = new AnalogInput(
			RobotMap.toteLeftIR);
	public static final AnalogInput toteRightIR = new AnalogInput(
	...
	// --Arm systems---
	public static final Talon armHeightMotor = new Talon(
			RobotMap.armHeightMotor);
	public static final VictorSP armLengthMotor = new VictorSP(
			RobotMap.armLengthMotor);
	public static final AnalogPotentiometer armPot = new AnalogPotentiometer(
			RobotMap.armPot, RobotMap.armPotScale);
	public static final DigitalInput armExtended = new DigitalInput(
			RobotMap.armExtended);
	public static final DigitalInput armRetracted = new DigitalInput(
			RobotMap.armRetracted);
	/**
	...
	public void disabledPeriodic() {
		...
		selectedAutonomous = (int) SmartDashboard.getNumber(
				"selectedAutonomous", selectedAutonomous); // Gets the
															// autonomous mode
															// from dashboard
	...
	public void autonomousInit() {
		...
		if (autonomousCommand[selectedAutonomous] != null)
			autonomousCommand[selectedAutonomous].start();
	}
	...
	public static double[] calculateCenter(double x1, double x2, double y1,
		...
		if (separation == 0.0) {
			...
			mirrorDistance = Math.sqrt(Math.pow(radius, 2)
