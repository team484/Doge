...
public class RobotMap {
	...
	public static double rotateValueMultiplier = 0.85; //For autonomous rotation
	public static double moveValueSlope = 12.0; //How early the robot slows down in inches
	public static double rotateValueSlope = 12.0; //How early the robot slows down in degrees
	...
	public static boolean rightEncoderReverse = false; //multiplies distance by -1
	public static double leftEncoderIncrement = -0.054287; //multiplier for left encoder distance
	public static double rightEncoderIncrement = 0.14370245; //multiplier for right encoder distance
